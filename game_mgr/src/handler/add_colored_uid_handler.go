...
func AddColoredUidHandler(body []byte, w http.ResponseWriter) {
	log := internal.GLog
	...
	internal.RedisDao.SAdd(setKey, request.UidList)

	internal.RedisDao.Set(redisKey, request.Activity, 0)
